...
#+begin_src emacs-lisp
  (defun my/set-font-faces ()
    "Sets the custom fonts for Onyx theme."
    ...
    (set-face-attribute 'fixed-pitch nil
                        ...
                        :height 160
                        :weight 'medium)
    ;; Re-apply italics if the theme stripped them
  ...
  (add-hook 'after-init-hook #'my/set-font-faces)

  ;; Run it again whenever a theme is enabled to prevent overrides
  (add-hook 'enable-theme-functions (lambda (&rest _) (my/set-font-faces)))
(defun my/apply-ui-customizations (&optional frame)
  "Apply fonts and UI colors to the provided FRAME or selected frame."
...
;; Standard Startup
(add-hook 'after-init-hook #'my/apply-ui-customizations)

;; Theme Switch Fix
(add-hook 'enable-theme-functions #'my/apply-ui-customizations)

;; MANDATORY FOR EMACSCLIENT:
(add-hook 'after-make-frame-functions #'my/apply-ui-customizations)
