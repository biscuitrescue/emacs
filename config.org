...
(elpaca (magit-section :fetcher github :repo "magit/magit"
...
#+begin_src emacs-lisp
  ...
  (setq ad-redefinition-action 'accept) ;; Silence warnings about function redefinitions
#+end_src
