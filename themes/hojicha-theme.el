;;; hojicha-theme.el --- hojicha
;;; Version: 1.0
;;; Commentary:
;;; A theme called hojicha
;;; Code:

(deftheme hojicha "DOCSTRING for hojicha")
  (custom-theme-set-faces 'hojicha
...
(provide-theme 'hojicha)

;;; hojicha-theme.el ends here
